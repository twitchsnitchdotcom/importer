...
public class SpendingDotGov {

    @Test
    public void spendingDotGov() throws InterruptedException {
        ...
        driver.get("https://sam.gov/data-services/Assistance%20Listings/usaspendinggov/historical?privacy=Public");
        driver.get("https://sam.gov/data-services/Assistance%20Listings/usaspendinggov/historical?privacy=Public");
