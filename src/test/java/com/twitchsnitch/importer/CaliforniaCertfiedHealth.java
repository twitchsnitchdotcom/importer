...
public class CaliforniaCertfiedHealth {

    private final static Logger log = LoggerFactory.getLogger(CaliforniaCertfiedHealth.class);
    ...
    public CaliforniaCertfiedHealth() throws IOException {
    }
