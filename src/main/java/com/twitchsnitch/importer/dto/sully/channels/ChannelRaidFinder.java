...
public class ChannelRaidFinder {
...
@JsonProperty("data")
private List<ChannelRaidDatum> data = null;
...
@JsonProperty("data")
public List<ChannelRaidDatum> getData() {
return data;
}

@JsonProperty("data")
public void setData(List<ChannelRaidDatum> data) {
this.data = data;
}
