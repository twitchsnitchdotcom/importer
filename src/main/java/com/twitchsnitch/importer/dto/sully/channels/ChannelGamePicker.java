...
public class ChannelGamePicker {
...
@JsonProperty("data")
private List<ChannelGamePickerDatum> data = null;
...
@JsonProperty("data")
public List<ChannelGamePickerDatum> getData() {
return data;
}

@JsonProperty("data")
public void setData(List<ChannelGamePickerDatum> data) {
this.data = data;
}
