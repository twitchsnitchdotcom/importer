...
@JsonProperty("footerLabels")
public FooterLabels getFooterLabels() {
return footerLabels;
}

@JsonProperty("footerLabels")
public void setFooterLabels(FooterLabels footerLabels) {
...
@JsonProperty("footerLabelIndex")
public List<String> getFooterLabelIndex() {
return footerLabelIndex;
}

@JsonProperty("footerLabelIndex")
public void setFooterLabelIndex(List<String> footerLabelIndex) {
